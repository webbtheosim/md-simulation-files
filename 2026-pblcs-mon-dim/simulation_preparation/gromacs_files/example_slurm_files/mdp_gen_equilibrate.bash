...
SRC_PATH="/scratch/gpfs/WEBB/jv6139/M_monomer/control-scripts/tREM/equilibrate/equilibrate_template.mdp"
DEST_DIR="/scratch/gpfs/WEBB/jv6139/M_monomer/control-scripts/tREM/equilibrate"
...
for TEMP in "${TEMPERATURES[@]}"; do
    ...
    cp "${SRC_PATH}" "${DEST_DIR}/equilibrate_${TEMP}.mdp"
    # Replace SET_TEMP in the copied file
    sed -i "s/SET_TEMP/${TEMP}/g" "${DEST_DIR}/equilibrate_${TEMP}.mdp"
    echo "Created ${DEST_DIR}/equilibrate_${TEMP}.mdp with temperature ${TEMP}"
done
