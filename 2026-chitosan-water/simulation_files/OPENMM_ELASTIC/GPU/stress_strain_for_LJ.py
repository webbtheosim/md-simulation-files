...
'Modified stress_strain.py code, where traj is saved more frequently, and only xx yy zz deformations are done'

def stress_strain(simulation, P_EVERY, EQUILIBRATION_LENGTH, RUN_LENGTH, dh=0.02):
